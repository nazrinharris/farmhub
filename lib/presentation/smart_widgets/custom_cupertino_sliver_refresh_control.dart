...
const double _kActivityIndicatorMargin = 100;
...
/// the same values passed into the [CustomCupertinoSliverRefreshControl].
///
...
/// A callback function that's invoked when the [CustomCupertinoSliverRefreshControl] is
/// pulled a `refreshTriggerPullDistance`. Must return a [Future]. Upon
/// completion of the [Future], the [CustomCupertinoSliverRefreshControl] enters the
...
///    [CustomCupertinoSliverRefreshControl] is part of the scrollable and actively occupies
///    scrollable space.
class CustomCupertinoSliverRefreshControl extends StatefulWidget {
  ...
  /// Retrieve the current state of the CustomCupertinoSliverRefreshControl. The same as the
  ...
  @override
  State<CustomCupertinoSliverRefreshControl> createState() => _CupertinoSliverRefreshControlState();
}

class _CupertinoSliverRefreshControlState extends State<CustomCupertinoSliverRefreshControl> {
