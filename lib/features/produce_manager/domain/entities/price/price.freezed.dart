...
/// @nodoc
class _$PriceAggregateTearOff {
  const _$PriceAggregateTearOff();

  _PriceAggregate call(Map<String, dynamic> aggregatePrices) {
    return _PriceAggregate(
      aggregatePrices,
    );
  }
}
...
/// @nodoc
const $PriceAggregate = _$PriceAggregateTearOff();

/// @nodoc
mixin _$PriceAggregate {
  Map<String, dynamic> get aggregatePrices =>
      throw _privateConstructorUsedError;
...
abstract class $PriceAggregateCopyWith<$Res> {
  ...
  $Res call({Map<String, dynamic> aggregatePrices});
}
...
class _$PriceAggregateCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? aggregatePrices = freezed,
  }) {
    return _then(_value.copyWith(
      aggregatePrices: aggregatePrices == freezed
          ? _value.aggregatePrices
          : aggregatePrices // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
abstract class _$PriceAggregateCopyWith<$Res>
    implements $PriceAggregateCopyWith<$Res> {
  factory _$PriceAggregateCopyWith(
          _PriceAggregate value, $Res Function(_PriceAggregate) then) =
      __$PriceAggregateCopyWithImpl<$Res>;
  @override
  $Res call({Map<String, dynamic> aggregatePrices});
}

/// @nodoc
class __$PriceAggregateCopyWithImpl<$Res>
    extends _$PriceAggregateCopyWithImpl<$Res>
    implements _$PriceAggregateCopyWith<$Res> {
  __$PriceAggregateCopyWithImpl(
      _PriceAggregate _value, $Res Function(_PriceAggregate) _then)
      : super(_value, (v) => _then(v as _PriceAggregate));

  @override
  _PriceAggregate get _value => super._value as _PriceAggregate;

  @override
  $Res call({
    Object? aggregatePrices = freezed,
  }) {
    return _then(_PriceAggregate(
      aggregatePrices == freezed
          ? _value.aggregatePrices
          : aggregatePrices // ignore: cast_nullable_to_non_nullable
              as Map<String, dynamic>,
    ));
...
class _$_PriceAggregate implements _PriceAggregate {
  _$_PriceAggregate(this.aggregatePrices);

  @override
  final Map<String, dynamic> aggregatePrices;

  @override
  String toString() {
    return 'PriceAggregate(aggregatePrices: $aggregatePrices)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PriceAggregate &&
            const DeepCollectionEquality()
                .equals(other.aggregatePrices, aggregatePrices));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(aggregatePrices));

  @JsonKey(ignore: true)
  @override
  _$PriceAggregateCopyWith<_PriceAggregate> get copyWith =>
      __$PriceAggregateCopyWithImpl<_PriceAggregate>(this, _$identity);
}

abstract class _PriceAggregate implements PriceAggregate {
  factory _PriceAggregate(Map<String, dynamic> aggregatePrices) =
      _$_PriceAggregate;
